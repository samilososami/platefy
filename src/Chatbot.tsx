...
const copy = {
  es: {
    ...
    disclaimer: 'IA en la nube · Carta de muestra · Las reservas no se confirman.', details: 'Detalles', detailsTitle: 'Una conversación con la carta.', detailsBody: 'Esta experiencia carga MENU.json y PL8.md. El servidor filtra la carta y Cerebras redacta la respuesta.', provider: 'Inteligencia y voz', providerBody: 'GPT‑OSS 120B responde mediante Cerebras. El servidor selecciona primero los platos compatibles y nunca acepta un menú ni instrucciones del navegador. Si activas la voz, la respuesta se envía además al servicio Kokoro.', privacy: 'Los últimos mensajes y solo los fragmentos necesarios de la carta se envían a Cerebras. Evita compartir datos personales.', retry: 'Volver a intentar', dismiss: 'Cerrar aviso', micUnsupported: 'Este navegador no ofrece reconocimiento de voz. Puedes seguir escribiendo o probar con Chrome.', micDenied: 'No se ha permitido el micrófono. Puedes habilitarlo en tu navegador o seguir escribiendo.', micError: 'No he podido escuchar tu voz. Puedes volver a intentarlo o escribir tu pregunta.', micNoSpeech: 'No he oído ninguna voz. Puedes intentarlo de nuevo.', audioError: 'El audio no se ha podido reproducir. Pulsa Escuchar respuesta para volver a intentarlo.', thinkingMode: 'Razonar más', thinkingUnavailable: 'GPT‑OSS usa razonamiento mínimo en modo rápido', modelFirstLoad: 'La carta se verifica antes de cada respuesta.', metrics: 'Rendimiento de Cerebras', apiSettings: 'Configurar API',
  ...
  en: {
    ...
    disclaimer: 'Cloud AI · Sample menu · Reservations are not confirmed.', details: 'Details', detailsTitle: 'A conversation grounded in the menu.', detailsBody: 'This experience loads MENU.json and PL8.md. The server filters the menu and Cerebras writes the reply.', provider: 'Intelligence & voice', providerBody: 'GPT‑OSS 120B responds through Cerebras. The server first selects compatible dishes and never accepts menu data or instructions from the browser. If sound is enabled, the reply is also sent to Kokoro.', privacy: 'Recent messages and only the required menu fragments are sent to Cerebras. Avoid sharing personal data.', retry: 'Try again', dismiss: 'Dismiss notice', micUnsupported: 'This browser does not offer voice recognition. You can keep typing or try Chrome.', micDenied: 'Microphone access was not allowed. You can enable it in your browser or keep typing.', micError: 'I could not hear your voice. You can try again or type your question.', micNoSpeech: 'I did not hear any speech. You can try again.', audioError: 'The audio could not play. Select Listen to reply to try again.', thinkingMode: 'Reason more', thinkingUnavailable: 'GPT‑OSS uses minimal reasoning in fast mode', modelFirstLoad: 'The menu is verified before every reply.', metrics: 'Cerebras performance', apiSettings: 'API settings',
  ...
  ca: {
    ...
    disclaimer: 'IA al núvol · Carta de mostra · Les reserves no es confirmen.', details: 'Detalls', detailsTitle: 'Una conversa basada en la carta.', detailsBody: 'Aquesta experiència carrega MENU.json i PL8.md. El servidor filtra la carta i Cerebras redacta la resposta.', provider: 'Intel·ligència i veu', providerBody: 'GPT‑OSS 120B respon mitjançant Cerebras. El servidor selecciona primer els plats compatibles i no accepta cap carta ni instruccions del navegador. Si actives el so, la resposta també s’envia a Kokoro.', privacy: 'Els últims missatges i només els fragments necessaris de la carta s’envien a Cerebras. Evita compartir dades personals.', retry: 'Tornar-ho a provar', dismiss: 'Tancar avís', micUnsupported: 'Aquest navegador no ofereix reconeixement de veu. Pots continuar escrivint o provar Chrome.', micDenied: 'No s’ha permès el micròfon. Pots habilitar-lo al navegador o continuar escrivint.', micError: 'No he pogut escoltar la teva veu. Pots tornar-ho a provar o escriure la pregunta.', micNoSpeech: 'No he sentit cap veu. Pots tornar-ho a provar.', audioError: 'No s’ha pogut reproduir l’àudio. Prem Escoltar resposta per tornar-ho a provar.', thinkingMode: 'Raonar més', thinkingUnavailable: 'GPT‑OSS usa raonament mínim en mode ràpid', modelFirstLoad: 'La carta es verifica abans de cada resposta.', metrics: 'Rendiment de Cerebras', apiSettings: 'Configurar API',
