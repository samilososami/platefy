...
const copy: Record<Locale, PageCopy> = {
  es: {
    ...
    text: {
      "live.title": "Una voz. Tres personalidades.", "live.subtitle": "Elige un restaurante y habla con platefy.", "live.openDemo": "Ver la demo", "live.mobileContext": "Tres restaurantes ficticios. Tres identidades para probar.", "live.chooser": "Elige un restaurante", "live.ko": "Cocina japonesa", "live.vita": "Cocina vegetal", "live.pica": "Tapas y mar", "live.koDetail": "Sushi · restaurante japonés", "live.vitaDetail": "Vegetal · mediterráneo", "live.picaDetail": "Tapas · cocina marinera", "live.story": "Tapas, mar y buenas conversaciones.", "live.swipe": "Desliza para cambiar", "live.previous": "Restaurante anterior", "live.next": "Siguiente restaurante", "live.loading": "Preparando tu mesa…", "live.retry": "Volver a intentar",
      'skip': 'Saltar al contenido', 'brand.home': 'platefy, inicio', 'nav.label': 'Navegación principal', 'footer.navLabel': 'Navegación del pie de página', 'nav.product': 'Producto', 'nav.how': 'Cómo funciona', 'nav.faq': 'FAQ', 'nav.try': 'Ver restaurantes', 'nav.openMenu': 'Abrir menú', 'nav.closeMenu': 'Cerrar menú', 'language': 'Idioma', 'orb.aria': 'Mascota esférica de platefy',
      'hero.eyebrow': 'ASISTENTE PARA RESTAURANTES', 'hero.title': 'platefy', 'hero.body': 'Responde, recomienda y orienta. platefy atiende a cada cliente desde tu propia web.', 'hero.primary': 'Ver restaurantes', 'hero.secondary': 'Ver cómo funciona', 'hero.note': 'Sin apps. En tu web. En su idioma.',
      ...
      'closing.label': 'UNA MEJOR BIENVENIDA', 'closing.title': 'Cada gran experiencia empieza con una buena conversación.', 'closing.cta': 'Encuentra tu restaurante', 'footer.note': 'IA para restaurantes, integrada en tu propia web.', 'footer.chat': 'Ver restaurantes', 'footer.rights': '© 2026 platefy',
    },
  },
  en: {
    ...
    text: {
      "live.title": "One voice. Three personalities.", "live.subtitle": "Choose a restaurant and talk to platefy.", "live.openDemo": "View the demo", "live.mobileContext": "Three fictional restaurants. Three identities to explore.", "live.chooser": "Choose a restaurant", "live.ko": "Japanese cuisine", "live.vita": "Plant-based cuisine", "live.pica": "Tapas & seafood", "live.koDetail": "Sushi · Japanese restaurant", "live.vitaDetail": "Plant-based · Mediterranean", "live.picaDetail": "Tapas · seafood cooking", "live.story": "Tapas, the sea and good conversation.", "live.swipe": "Swipe to switch", "live.previous": "Previous restaurant", "live.next": "Next restaurant", "live.loading": "Preparing your table…", "live.retry": "Try again",
      'skip': 'Skip to content', 'brand.home': 'platefy, home', 'nav.label': 'Main navigation', 'footer.navLabel': 'Footer navigation', 'nav.product': 'Product', 'nav.how': 'How it works', 'nav.faq': 'FAQ', 'nav.try': 'Explore restaurants', 'nav.openMenu': 'Open menu', 'nav.closeMenu': 'Close menu', 'language': 'Language', 'orb.aria': 'platefy spherical mascot',
      'hero.eyebrow': 'AI ASSISTANT FOR RESTAURANTS', 'hero.title': 'platefy', 'hero.body': 'Answers, recommends and guides. platefy helps every guest from your own website.', 'hero.primary': 'Explore restaurants', 'hero.secondary': 'See how it works', 'hero.note': 'No apps. On your website. In their language.',
      ...
      'closing.label': 'A BETTER WELCOME', 'closing.title': 'Every great experience begins with a good conversation.', 'closing.cta': 'Find your restaurant', 'footer.note': 'AI for restaurants, embedded in your own website.', 'footer.chat': 'Explore restaurants', 'footer.rights': '© 2026 platefy',
    },
  },
  ca: {
    ...
    text: {
      "live.title": "Una veu. Tres personalitats.", "live.subtitle": "Tria un restaurant i parla amb platefy.", "live.openDemo": "Veure la demo", "live.mobileContext": "Tres restaurants ficticis. Tres identitats per provar.", "live.chooser": "Tria un restaurant", "live.ko": "Cuina japonesa", "live.vita": "Cuina vegetal", "live.pica": "Tapes i mar", "live.koDetail": "Sushi · restaurant japonès", "live.vitaDetail": "Vegetal · mediterrani", "live.picaDetail": "Tapes · cuina marinera", "live.story": "Tapes, mar i bones converses.", "live.swipe": "Llisca per canviar", "live.previous": "Restaurant anterior", "live.next": "Restaurant següent", "live.loading": "Preparant la teva taula…", "live.retry": "Torna-ho a provar",
      'skip': 'Ves al contingut', 'brand.home': 'platefy, inici', 'nav.label': 'Navegació principal', 'footer.navLabel': 'Navegació del peu de pàgina', 'nav.product': 'Producte', 'nav.how': 'Com funciona', 'nav.faq': 'FAQ', 'nav.try': 'Veure restaurants', 'nav.openMenu': 'Obrir menú', 'nav.closeMenu': 'Tancar menú', 'language': 'Idioma', 'orb.aria': 'Mascota esfèrica de platefy',
      'hero.eyebrow': 'ASSISTENT PER A RESTAURANTS', 'hero.title': 'platefy', 'hero.body': 'Respon, recomana i orienta. platefy atén cada client des del teu propi web.', 'hero.primary': 'Veure restaurants', 'hero.secondary': 'Descobreix com funciona', 'hero.note': 'Sense apps. Al teu web. En el seu idioma.',
      ...
      'closing.label': 'UNA MILLOR BENVINGUDA', 'closing.title': 'Cada gran experiència comença amb una bona conversa.', 'closing.cta': 'Troba el teu restaurant', 'footer.note': 'IA per a restaurants, integrada al teu propi web.', 'footer.chat': 'Veure restaurants', 'footer.rights': '© 2026 platefy',
    },
  },
};
...
// Only the chooser is eagerly loaded; its single chat frame mounts near the viewport.
void import('./restaurant-demo');
