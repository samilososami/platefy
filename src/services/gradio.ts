export type ProviderErrorCode = 'ABORTED' | 'TIMEOUT' | 'RATE_LIMIT' | 'QUOTA' | 'BILLING' | 'AUTH' | 'UNAVAILABLE' | 'INVALID_RESPONSE' | 'UNSUPPORTED_LANGUAGE' | 'UNSUPPORTED_BROWSER' | 'KNOWLEDGE_UNAVAILABLE'
